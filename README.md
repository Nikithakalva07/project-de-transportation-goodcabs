...
> 📝 **Note:** Built as a guided learning project to develop hands-on skills with Databricks LakeFlow Spark Declarative Pipelines.

---

## 📌 Project Overview

A rapidly growing cab service company was facing critical data challenges at scale. Regional managers were receiving delayed, generic insights, and the existing procedural Spark pipelines were rigid, tightly coupled, and slow to adapt to business needs.
...
Amazon S3 (CSV files)
  ...
  [ Silver Layer ]   ← Cleaned, transformed, validated data
        ↓
  [ Gold Layer ]     ← BI-ready, region-specific views
```
...
/gold
  └── gold_views.py          # Region-specific BI-ready views
...
### 🥇 Gold Layer
- Generates region-specific views for regional managers
...
- **Access Management:** Unity Catalog restricts regional managers to their region-specific data only
...
Built as a guided learning project to develop hands-on skills with **Databricks LakeFlow Spark Declarative Pipelines**.  
